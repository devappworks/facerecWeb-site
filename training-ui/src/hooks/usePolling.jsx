 ...
 * @param {Array} dependencies - Optional array of dependencies to trigger refetch (default: [])
 * @returns {Object} - { data, loading, error, refetch, startPolling, stopPolling }
 */
export function usePolling(fetchFn, interval = 5000, enabled = true, dependencies = []) {
