export const helpContent = {
  ...
  'queue-management': {
    ...
    sections: [
      {
        heading: 'What is Queue Management?',
        content:
          'View and manage all celebrity names that were generated by AI and are waiting to be processed. This page shows you exactly what\'s in the queue before images are downloaded.',
      },
      {
        heading: 'Queue Overview',
        content:
          'See total names in queue, how many have been processed, how many remain, and how many different categories (Actor, Musician, etc.) are included. The queue is grouped by occupation/category for easy navigation.',
      },
      {
        heading: 'Removing Names',
        content:
          'Click the "Remove" button next to any name to delete it from the queue. This is useful if you don\'t want to train on certain celebrities or if duplicates were generated. Removal is immediate and cannot be undone.',
      },
      {
        heading: 'Auto-Refresh',
        content:
          'The queue automatically refreshes every 30 seconds to show the latest data. You can pause/resume auto-refresh using the toggle button, or manually refresh at any time.',
      },
      {
        heading: 'Workflow Integration',
        content:
          'Names are added to this queue when you use "Generate Names" in Training Workflow. When you click "Process Next" or "Process All" in Training Workflow, names are taken from this queue and images are downloaded.',
      },
      {
        heading: 'Categories Display',
        content:
          'Queue entries are grouped by their occupation/category (Actor, Musician, Athlete, etc.). Each category section shows how many people are in that category. This helps you see the distribution of your training data.',
      },
      {
        heading: 'Best Practices',
        content:
          'Review the queue before processing to ensure quality. Remove any unwanted names early to save processing time. Check that you have a good mix of categories. Empty queue means you need to generate more names in Training Workflow.',
      },
    ],
  },
